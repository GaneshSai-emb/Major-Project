...
u32 cnt;
int gsm_flag; //this flag gsm connection 
//Gsm intialization
void gsm_init(void)
{
   //display AT command on LCD
    CmdLCD(0x01);  
	...
	UART0_Str("AT\r\n"); //transmits  the AT command to GSM module
...
//display at+cmgf command
...

	{
	 ...
	 gsm_flag=1; //Gsm sucessfully intialized
}
